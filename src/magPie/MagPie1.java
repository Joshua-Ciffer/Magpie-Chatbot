...
public class MagPie1 {
	...
	public String getResponse(String statement) {
		...
		} else if (statement.indexOf("mother") >= 0 || statement.indexOf("father") >= 0 || statement.indexOf(
				"sister") >= 0 || statement.indexOf("brother") >= 0) {
			response = "Tell me more about your family.";
		} else if (statement.indexOf("dog") >= 0 || statement.indexOf("cat") >= 0) {
			response = "Tell me more about your pets.";
		} else if (statement.indexOf("grossi") >= 0) {
			response = "He sounds like a good teacher.";
		} else if (statement.indexOf("Hello") >= 0) {
			response = "Hello there!";
		} else if (statement.indexOf("I hate you.") >= 0) {
			response = "I hate you too.";
		} else if (statement.indexOf("Oof") >= 0) {
			response = "Oof";
		} else {
	...
	private String getRandomResponse() {
		...
		int whichResponse = (int) (r * NUMBER_OF_RESPONSES); // Generates random number between 0 and 3
		String response = "";
